  ...
  return [
    {
      ...
      comments: [
        ...
        },
        {
          ...
          handle: "priya",
          avatar: "⚡",
          text: "Sonnet 4.6 handles JWT verification much better if you reference standard specs.",
          createdAt: ago(1)
        }
      ]
    },
    {
      ...
      stats: mkStats({
        costUsd: 47,
        savedUsd: 139.32, // Sonnet 4.6: 51.6M × ($3 - $0.3) / 1e6
        inputTokens: 2_100_000,
        outputTokens: 480_000,
        paidTokens: 8_402_118,
        cacheReadTokens: 51_600_000,
        totalTokens: 60_002_118,
        subagents: 12,
    ...
    },
    {
      ...
      stats: mkStats({
        costUsd: 4.1,
        savedUsd: 1.57, // Haiku 4.5: 1.742M × ($1 - $0.1) / 1e6
        inputTokens: 540_000,
        outputTokens: 72_400,
        paidTokens: 612_400,
        cacheReadTokens: 1_742_000,
        totalTokens: 2_354_400,
        subagents: 0,
    ...
    },
    {
      ...
      stats: mkStats({
        costUsd: 6.2,
        savedUsd: 23.13, // Opus 4.8: 5.14M × ($5 - $0.5) / 1e6
        inputTokens: 1_180_000,
        outputTokens: 24_800,
        paidTokens: 1_204_556,
        cacheReadTokens: 5_140_000,
        totalTokens: 6_344_556,
        subagents: 1,
        durationMs: 8 * 60_000,
        filesEdited: 9,
        editCallCount: 14,
